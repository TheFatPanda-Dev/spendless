    ...
    useEffect(() => {
        ...
        const loadInstitutions = async () => {
            try {
                ...
                const resolvedInstitutions: Array<{
                    name: string;
                    country: string;
                }> =
                    payload?.preferred?.length > 0
                        ? payload.preferred
            ...
            <div className="flex h-full flex-1 flex-col gap-6">
                <Card className="border-brand/20 bg-linear-to-br from-brand/6 via-card to-card dark:from-brand/10">
                    <CardHeader className="gap-2">
                        ...
                        <CardDescription>
                            Connect your bank and keep accounts synced in one
                            place.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form
                            action="/banking/connect"
                            method="post"
                                    ...
                                    >
                                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    router.delete(
                                                        `/banking/connections/${connection.id}`,
                                                        {
                                                            preserveScroll: true,
                                                            preserveState: true,
                                                        },
